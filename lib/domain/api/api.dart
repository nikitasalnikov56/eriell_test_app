  ...
  static void setupHttpClient() {
    ...
    dio.httpClientAdapter = IOHttpClientAdapter(
      ...
      createHttpClient: () {
        ...
        //X509Certificate - Это класс, представляющий сертификат X.509. 
        //Сертификаты X.509 являются стандартом для управления цифровыми сертификатами и криптографическими ключами. 
        //В данном случае объект X509Certificate передается в функцию обратного вызова badCertificateCallback, 
        //что позволяет проверять информацию о сертификате, хосте и порте.
        return client;
      },
    );
  }
